...
function pwasite_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'pwasite' ),
            //'description' => __( 'This is a section for the typography', 'pwasite' ),
            'priority' => 20,
        )
    );
    //Theme Option
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'pwasite' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'pwasite' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','pwasite' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'pwasite' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'pwasite'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'pwasite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'pwasite' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'pwasite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'pwasite' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'pwasite' ),
            //'description' => __( 'This is a section for the header banner Image.', 'pwasite' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'pwasite_logo', array(
        //'default' => __( '', 'pwasite' ),
        'sanitize_callback' => 'esc_url',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'pwasite_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'pwasite' ),
        'section'  => 'title_tagline',
        'settings' => 'pwasite_logo',
    ) ) );

}
add_action( 'customize_register', 'pwasite_customize_register' );

add_action( 'wp_head', 'pwasite_customizer_css');
function pwasite_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function pwasite_customize_preview_js() {
    wp_enqueue_script( 'pwasite_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'pwasite_customize_preview_js' );
